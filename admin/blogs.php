...
$query = mysqli_query($db_conn,"SELECT SQL_CALC_FOUND_ROWS * FROM blog, users
	...
	<table class="table border">
		<thead class="thead-light">
			<tr>
				...
				<th><a class="text-secondary" href="?<?php echo $url_query_strings_sb; ?>&sortby=blog_created_at&order=<?php echo $order; ?>">Date</a></th>
